...
func RegisterWorkerTokensServer(s grpc.ServiceRegistrar, srv WorkerTokensServer) {
	s.RegisterService(&WorkerTokens_ServiceDesc, srv)
}
...
// WorkerTokens_ServiceDesc is the grpc.ServiceDesc for WorkerTokens service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var WorkerTokens_ServiceDesc = grpc.ServiceDesc{
